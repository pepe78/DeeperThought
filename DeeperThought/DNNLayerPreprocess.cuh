...
private:
	...
	CPUGPUMemory *dom;
public:
	DNNLayerPreprocess(int _x1, int _x2, int _batchSize, float _minAngle, float _maxAngle, float _minStretch, float _maxStretch, float _minNoise, float _maxNoise, int _flipHor, int _flipVer, int _x1SamplePoints, int _x2SamplePoints);
	~DNNLayerPreprocess();
